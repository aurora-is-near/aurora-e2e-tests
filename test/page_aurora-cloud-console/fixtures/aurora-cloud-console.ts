...
import auroraCloudSetup from "../../wallet-setup/aurora-cloud-console.setup"
import { AURORA_CLOUD_CONSOLE_PAGE } from "../../helpers/constants/pages"

export const test = testWithSynpress(
  metaMaskFixtures(auroraCloudSetup),
).extend<{
  auroraCloudPreconditions: {
    loginToSupabase: () => Promise<void>
  }
}>({
  auroraCloudPreconditions: async ({ page, context }, use) => {
