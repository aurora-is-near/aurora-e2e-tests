...
export class HomePage extends BasePage {
  ...
  constructor(page: Page) {
    ...
    this.fromBalance = page.getByText("Balance:").nth(0)
    this.toBalance = page.getByText("Balance:").nth(1)
  ...
  async getFromTokenBalance(): Promise<number> {
    ...
    await expect(this.fromBalance, messageOnFail).toBeVisible(midTimeout)
    const balanceText = (await this.fromBalance.innerText()).toString()
